...
async function checkCommand(name: string, cmd: string): Promise<DiagnosticCheck> {
  try {
...
export async function runDiagnostics(): Promise<DiagnosticsResult> {
  ...
  // ── 1. Backend Server ────────────────────────────────────────
  const backendChecks: DiagnosticCheck[] = [];
  ...
  // ── 3. Tools ─────────────────────────────────────────────────
  const toolChecks: DiagnosticCheck[] = [];
  ...
  // ── 4. Desktop Control ───────────────────────────────────────
  const desktopChecks: DiagnosticCheck[] = [];
  ...
  // ── 5. Browser ───────────────────────────────────────────────
  const browserChecks: DiagnosticCheck[] = [];
  ...
  // ── 6. File System ───────────────────────────────────────────
  const fsChecks: DiagnosticCheck[] = [];
  ...
  const overall: 'ok' | 'warning' | 'error' = hasError ? 'error' : hasWarning ? 'warning' : 'ok';
